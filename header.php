...
<head>
	<meta charset="UTF-8">
	<title><?php echo NAME; ?> 成员认证系统</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<script type="text/javascript" src="http://flyui.qiniudn.com/jquery.min.js"></script>
	<link href="http://flyui.qiniudn.com/bootstrap.css" rel="stylesheet">
	...
	<div class="masthead">
		<div class="pull-right">
			<ul class="nav nav-pills">
				...
				<li class=""><a href="<?php echo URL; ?>" target="_blank">LiveFace官网</a></li>
				<li class=""><a href="<?php echo BBS_URL; ?>" target="_blank">Liveface论坛</a></li>
			</ul>
		</div>
		<h3><?php echo NAME; ?></h3>
	</div>
